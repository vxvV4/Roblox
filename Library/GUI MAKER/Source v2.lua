...
local M = Instance.new("Frame", G)
M.Size = UDim2.new(0, 200, 0, 30)
M.Position = UDim2.new(0.5, -100, 0.5, -15) -- CENTERED NA TO BRO!
M.AnchorPoint = Vector2.new(0.5, 0.5) -- ANCHOR POINT PARA EXACT CENTER
M.BackgroundColor3 = Color3.new(0, 0, 0)
M.BorderSizePixel = 0
M.Active = true
...
local L = Instance.new("UIListLayout", C)
L.Padding = UDim.new(0, 3)
L.HorizontalAlignment = Enum.HorizontalAlignment.Center -- CENTERED NA LAHAT NG ELEMENTS!
...
function ParZ(txt)
    ...
    l.TextXAlignment = Enum.TextXAlignment.Center -- CENTERED TEXT NA!
end
