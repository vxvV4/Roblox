...
-- Main Frame ( i make this very small for mobile )
...
-- ============================================
local function createToggle(text, position, onToggle)
    local ToggleFrame = Instance.new("Frame")
    ToggleFrame.Size = UDim2.new(0.85, 0, 0, 35)
    ...
    Label.Text = text
    Label.TextColor3 = THEMES[CURRENT_THEME].Text
    Label.TextSize = 13
    ...
    ToggleBack.BackgroundColor3 = Color3.fromRGB(60, 60, 60)
...
-- ============================================
-- TOGGLE EXAMPLES (PUT YOUR LOGIC HERE!)
-- ============================================

-- Toggle 1 - ESP Example
createToggle("ESP", UDim2.new(0.075, 0, 0, 140), function(state)
    if state then
        print("ESP Enabled!")
        -- PUT YOUR ESP ON CODE HERE
    else
        print("ESP Disabled!")
        -- PUT YOUR ESP OFF CODE HERE
    end
end)

-- Toggle 2 - Speed Example
createToggle("Speed", UDim2.new(0.075, 0, 0, 185), function(state)
    if state then
        print("Speed Enabled!")
        -- PUT YOUR SPEED ON CODE HERE
        -- Example:
        -- game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 100
    else
        print("Speed Disabled!")
        -- PUT YOUR SPEED OFF CODE HERE
        -- Example:
        -- game.Players.LocalPlayer.Character.Humanoid.WalkSpeed = 16
    end
end)

-- Toggle 3 - Aimbot Example
createToggle("Aimbot", UDim2.new(0.075, 0, 0, 230), function(state)
    if state then
        print("Aimbot Enabled!")
        -- PUT YOUR AIMBOT ON CODE HERE
    else
        print("Aimbot Disabled!")
        -- PUT YOUR AIMBOT OFF CODE HERE
    end
end)

-- Button 4 - Close Button
createButton("Close", UDim2.new(0.075, 0, 0, 275), function()
    ScreenGui:Destroy()
end)
